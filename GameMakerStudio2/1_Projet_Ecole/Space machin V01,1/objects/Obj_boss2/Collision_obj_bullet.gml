...
if(__dnd_health <= 0)
{
	...
	/// @DnDArgument : "objectid" "Obj_explod3"
	/// @DnDSaveInfo : "objectid" "Obj_explod3"
	instance_create_layer(x + sprite_width/10, y + 0, "Instances", Obj_explod3);
