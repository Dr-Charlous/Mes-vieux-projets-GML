...
if((repro > 90) and (repro > food) and (repro > drink))
{
	if(collision_circle(x, y, range, obj_creature_M, false, true))
	{
		var x_v = instance_nearest(x, y, obj_creature_M).x;
		var y_v = instance_nearest(x, y, obj_creature_M).y;
		direction = point_direction(x, y, x_v, y_v);
	}
}
...
if(place_meeting(x, y, instance_nearest(x, y, obj_creature_M)) and (repro = 100))
{
